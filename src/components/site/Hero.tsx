...
export function Hero() {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto flex h-full max-w-7xl flex-col justify-end px-5 pb-28 pt-28 sm:pb-32 lg:px-8">
        <div key={active.id} className="max-w-3xl animate-fade-in">
          <p className="flex items-center gap-3 text-xs font-semibold uppercase tracking-[0.32em] text-primary">
            <span className="h-px w-8 bg-primary" />
            {active.label}
          </p>
          <h1 className="mt-5 font-display text-[2.1rem] font-bold leading-[1.06] tracking-tight text-inverse sm:text-5xl lg:text-6xl">
            {active.headline}
          </h1>
